    ...
    <Box flex="1" color="whiteAlpha.700" pt={{ base: 10, md: 16 }} pb={{ base: 20, md: 24 }}>
      <Container maxW="container.md">
        <VStack spacing={5} align="start">
          ...
          <Heading as="h2" size="sm" color="white" mt={4}>Description of Service</Heading>
          <Text fontSize="sm" lineHeight="1.8">
          ...
          <Heading as="h2" size="sm" color="white" mt={4}>User Accounts</Heading>
          ...
          <Text fontSize="sm" lineHeight="1.8" color="whiteAlpha.800" fontWeight="500">Account Termination</Text>
          <Text fontSize="sm" lineHeight="1.8">
          ...
          <Heading as="h2" size="sm" color="white" mt={4}>User Conduct</Heading>
          <Text fontSize="sm" lineHeight="1.8">You agree not to use the App to:</Text>
          ...
          <Heading as="h2" size="sm" color="white" mt={4}>Intellectual Property</Heading>

          <Text fontSize="sm" lineHeight="1.8" color="whiteAlpha.800" fontWeight="500">Our Intellectual Property</Text>
          <Text fontSize="sm" lineHeight="1.8">
          ...
          <Text fontSize="sm" lineHeight="1.8" color="whiteAlpha.800" fontWeight="500">User Content</Text>
          <Text fontSize="sm" lineHeight="1.8">
          ...
          <Heading as="h2" size="sm" color="white" mt={4}>Disclaimers</Heading>

          <Text fontSize="sm" lineHeight="1.8" color="whiteAlpha.800" fontWeight="500">As-Is Service</Text>
          <Text fontSize="sm" lineHeight="1.8">
            The App is provided on an "as is" and "as available" basis without warranties of any kind, either
            express or implied.
          </Text>

          <Text fontSize="sm" lineHeight="1.8" color="whiteAlpha.800" fontWeight="500">Technical Issues</Text>
          <Text fontSize="sm" lineHeight="1.8">
            We do not guarantee that the App will always be secure, error-free, or available at any particular
            time or location.
          </Text>

          <Text fontSize="sm" lineHeight="1.8" color="whiteAlpha.800" fontWeight="500">Third-Party Links</Text>
          <Text fontSize="sm" lineHeight="1.8">
          ...
          <Heading as="h2" size="sm" color="white" mt={4}>Limitation of Liability</Heading>
          <Text fontSize="sm" lineHeight="1.8">
          ...
          <Heading as="h2" size="sm" color="white" mt={4}>Indemnification</Heading>
          <Text fontSize="sm" lineHeight="1.8">
          ...
          <Heading as="h2" size="sm" color="white" mt={4}>Changes to These Terms</Heading>
          <Text fontSize="sm" lineHeight="1.8">
          ...
          <Heading as="h2" size="sm" color="white" mt={4}>Governing Law</Heading>
          <Text fontSize="sm" lineHeight="1.8">
            These Terms shall be governed by and construed in accordance with the laws of the United States, without
            regard to its conflict of law provisions.
          </Text>

          <Heading as="h2" size="sm" color="white" mt={4}>Severability</Heading>
          <Text fontSize="sm" lineHeight="1.8">
          ...
          <Heading as="h2" size="sm" color="white" mt={4}>Entire Agreement</Heading>
          <Text fontSize="sm" lineHeight="1.8">
